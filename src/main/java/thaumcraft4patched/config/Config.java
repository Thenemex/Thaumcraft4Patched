...
public class Config extends AConfig {
    ...
    protected void loadConfig() {
        ...
        thaumcraftMagicalLeavesFastDecayPatchEnabled = newEntry(
                fld,
                "ThaumcraftMagicalLeaves",
                "Makes Greatwood and Silverwood leaves use Fast Leaf Decay's configured decay speed"
        );

        taintedMagicWarpwoodLeavesFastDecayPatchEnabled = newEntry(
                fld,
                "TaintedMagicWarpwoodLeaves",
                "Makes Tainted Magic Warpwood leaves use Fast Leaf Decay's configured decay speed"
        );
        comment(
                tcon,
                "You can disable/enable compatibility patches for Thaumic Concilium here"
        );

        thaumaturgeWitcheryGuardNonAggressionPatchEnabled = newEntry(
                tcon,
                "WitcheryGuardNonAggression",
